...
type ParameterValidatorFunction<Type, Key extends keyof Type> = (
   obj: Type,
   key: Key
) => void
...
>(obj: Type, validator: ObjectValidator<Type>): void {
      ...
      if (paramValidator !== undefined) {
         if (typeof paramValidator === "function") {
            ...
            if (
               ...
               paramValidator.min !== undefined
            ) {
               if ((obj[key] as number) < paramValidator.min) {
                  obj[key] = paramValidator.min as Type[Key]
               }
            }
            if (
               typeof obj[key] === "number" &&
               paramValidator.max !== undefined
            ) {
               if ((obj[key] as number) > paramValidator.max) {
